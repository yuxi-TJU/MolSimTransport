...
def extract_middle_part(poscar_atoms, filename='EM_atoms.txt'):
    middle_atoms = poscar_atoms[36:-36] 
    with open(filename, 'w') as f:
...
xyz_filename = 'junction_example_adatom_amine.xyz'   # Change to your XYZ file         
...
lattice_vectors = [  
    [8.6512700, 0.0, 0.0],  # Example lattice vector 
...
if input_atom_count - output_atom_count == 20:
