...
########################################################################################################################
    ...
    input_energy_interval = 0.0025  # Energy interval (float)
    ...
    with ProcessPoolExecutor(max_workers=1) as executor:
        futures = [executor.submit(create_and_run_for_field, base_dir, poscar_file, eefs, input_energy_range,
                                    input_energy_interval, save_mat_files)
